...
class ShopViewController: ViewController, SKProductsRequestDelegate {
    ...
    override func viewDidLoad() {
        ...
        [nounSwitch .addTarget(self, action: "changeNoun", forControlEvents: UIControlEvents.ValueChanged)]
        [verbSwitch .addTarget(self, action: "changeVerb", forControlEvents: UIControlEvents.ValueChanged)]
        [adjectiveSwitch .addTarget(self, action: "changeAdje", forControlEvents: UIControlEvents.ValueChanged)]
